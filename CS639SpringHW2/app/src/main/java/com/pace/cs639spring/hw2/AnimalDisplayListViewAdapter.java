...
public class AnimalDisplayListViewAdapter extends BaseAdapter {
    ...
    public final String label = "AnimalDisplayListView";
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.layout_1, null);
            ViewHolder viewHolder = new ViewHolder((ImageView) convertView.findViewById(R.id.animalImg),
                    (TextView) convertView.findViewById(R.id.animalTxt),
                    (Button)convertView.findViewById(R.id.descNextBtn),
                    (Button)convertView.findViewById(R.id.descDelBtn));
        ...
        viewHolder.mImageView.setImageResource(object.ImageId);
        viewHolder.mImageView.setTag(object.ImageId);
        viewHolder.mTextView.setText(object.AnimalList != null && !object.AnimalList.isEmpty() ? object.AnimalList.get(0):"");
        viewHolder.mAnimalDescList = object.AnimalList;
